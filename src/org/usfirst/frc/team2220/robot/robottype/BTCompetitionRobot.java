...
public class BTCompetitionRobot
{
	...
	public BTLimitSwitch TOTE_LIMIT = new BTLimitSwitch(BTConstants.COMPETITION_TOTE_LIMIT);
	public BTLimitSwitch PRIMARY_LOWER_LIMIT_LEFT = new BTLimitSwitch(BTConstants.COMPETITION_PRIMARY_LOWER_LIMIT_LEFT);
//	public BTLimitSwitch PRIMARY_LOWER_LIMIT_RIGHT = new BTLimitSwitch(BTConstants.COMPETITION_PRIMARY_LOWER_LIMIT_RIGHT);
//	public BTLimitSwitch PRIMARY_MIDDLE_LIMIT_LEFT = new BTLimitSwitch(BTConstants.COMPETITION_PRIMARY_MIDDLE_LIMIT_LEFT);
//	public BTLimitSwitch PRIMARY_MIDDLE_LIMIT_RIGHT = new BTLimitSwitch(BTConstants.COMPETITION_PRIMARY_MIDDLE_LIMIT_RIGHT);
//	public BTLimitSwitch PRIMARY_UPPER_LIMIT_LEFT = new BTLimitSwitch(BTConstants.COMPETITION_PRIMARY_UPPER_LIMIT_LEFT);
//	public BTLimitSwitch PRIMARY_UPPER_LIMIT_RIGHT = new BTLimitSwitch(BTConstants.COMPETITION_PRIMARY_UPPER_LIMIT_RIGHT);
//	public BTLimitSwitch SECONDARY_LOWER_LIMIT = new BTLimitSwitch(BTConstants.COMPETITION_SECONDARY_LOWER_LIMIT);
//	public BTLimitSwitch SECONDARY_UPPER_LIMIT = new BTLimitSwitch(BTConstants.COMPETITION_SECONDARY_UPPER_LIMIT);
...
//	public BTTalonSRX BARREL_MOTOR_LEFT = new BTTalonSRX(BTConstants.COMPETITION_BARREL_MOTOR_LEFT);
//	public BTTalonSRX BARREL_MOTOR_RIGHT = new BTTalonSRX(BTConstants.COMPETITION_BARREL_MOTOR_RIGHT);
