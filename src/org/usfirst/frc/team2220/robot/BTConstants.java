...
public class BTConstants
{
	...
	public static final int MOVE_FORWARD_TIME_LONG = 3000;
	...
	public static final double BACK_SHORT_SPEED = 0.2;
	public static final double BACK_LONG_SPEED = 0.2;

	public static final double AUTONOMOUS_ROTATE_SPEED = 0.5;
	public static final double AUTONOMOUS_ROTATE_TIME = 3000;
	public static final long AUTONOMOUS_FORWARD_TIME = 3000;
	public static final long AUTONOMOUS_LOWER_BARREL_TIME = 500;
